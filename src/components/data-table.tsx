...
import { ProcessData } from "@/schemas/clientSchemas";
...
const columns: ColumnDef<ProcessData>[] = [
  {
    id: "drag",
    header: () => null,
  ...
  {
    accessorKey: "opposing_party",
    header: "Parte Contrária",
  },
  {
    accessorKey: "lawyer_name",
    header: "Advogado Oponente",
  },
  {
    accessorKey: "status",
    header: "Status",
...
function DraggableRow({ row }: { row: Row<ProcessData> }) {
...
export function DataTable({
  ...
  const { title } = dataNavigation.processRegister;
  const { id: clientId } = useParams();

  const filteredData = React.useMemo(() => {
    return initialData.filter((process) => process.client_id === clientId);
    ...
    <Tabs defaultValue="outline" className="w-full flex-col justify-start gap-6">
      <div className="flex mb-4 gap-2">
        ...
        <Button
          type="button"
          variant="default"
          onClick={() => router.push(`/logged/clients/${clientId}/client/process`)}
